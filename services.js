...
function RegisterUser(){
    ...
    attributeList.push(new AmazonCognitoIdentity.CognitoUserAttribute({Name:"custom:agentName",Value:"sampleAgentName"}));
    ...
    */
    ...
    return userPool.signUp('z.zarza.mec@gmail.com',
        'pass123!!!',
        attributeList,
        null,
        function(err, result){
...
function Login() {
    var authenticationDetails = new AmazonCognitoIdentity.AuthenticationDetails({
        Username : 'z.zarza.mec@gmail.com',
        Password : 'pass123!!!',
    });
